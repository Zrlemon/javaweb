        ...
        <form id = "form" class="layui-form" action="" method="post">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <input type="radio" name="character" lay-skin="primary" value="超级管理员" title="超级管理员" >
                <input type="radio" name="character" lay-skin="primary" value="管理人员" title="管理人员">
                <input type="radio" name="character" lay-skin="primary" value="普通用户" title="普通用户" >
              </div>
          </div>
          <div class="layui-form-item">

...
<body>
    ...
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="./index.jsp">admin</a></div>
        <!--<div class="left_open">
    ...
    <div class="left-nav">
      <div id="side-nav">
        ...
        <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/admin/admin-list.jsp">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>管理员列表</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/admin/fileupload.jsp">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>文件操作</cite>
                        </a>
                    </li >
    ...
    <!-- 底部开始 -->
    <div class="footer">
        <div class="copyright">Copyright admin All Rights Reserved</div>  
    </div>
    <!-- 底部结束 -->
